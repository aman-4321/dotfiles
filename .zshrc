...
plugins=(zsh-autosuggestions zsh-syntax-highlighting web-search git-prompt sudo fzf zsh-completions docker command-not-found httpie kind kubectl nvm rust helm npm)
